...
class VideoAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        user_obj.save()
        blog_post = Video.objects.create(user=user_obj, title='New Title', content='some_random_content whey')
    ...
    def test_get_list(self):
        data = {}
        url = api_reverse('api-videos:video-listcreate')
