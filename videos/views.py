...
from commentaries.forms import CommentariesForm
...
def video_detail(request, cat_slug, vid_slug):
    ...
    if request.user.is_authenticated or obj.has_preview:
        ...
        if is_member or obj.has_preview:
            commentaries = obj.commentaries_set.all()
            for c in commentaries:
                c.get_children()
            commentaries_form = CommentariesForm()
            context = {"obj": obj, "commentaries": commentaries, "commentaries_form": commentaries_form}
