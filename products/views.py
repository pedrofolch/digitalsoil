...
def user_gains_perms(request, user_id):
    ...
    user.has_perm('products.product_create')

    content_type = ContentType.objects.get_for_model(Product)
    permission = Permission.objects.get(
        codename='product_create',
...
#         product_slug = self.kwargs.get("slug")  # grab the primary key of the object
#         product_query = Product.objects.filter(slug=product_slug)  # returns a list with the filtered results
#         if product_query.exists():
#             product_object = product_query.first()  # grab the first item in the list if it exists
